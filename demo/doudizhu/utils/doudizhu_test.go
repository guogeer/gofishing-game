...
func TestDoudizhuTurn3(t *testing.T) {
	...
	samples := []doudizhuAIResult{
		{ai: &DoudizhuAI{
			MySeat: 0, Dizhu: 0, UsedCards: []int{0x14, 0x35, 0x16, 0x17, 0x08, 0x38, 0x09, 0x2a, 0x3b, 0x1c}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{0x02, 0x03, 0x0b, 0x12, 0x1a, 0x1b, 0x22, 0x26, 0x27, 0x28, 0x2b, 0x2c, 0x33, 0x39, 0x3d}, Step: []int{}, CardNum: 15}, &DoudizhuUser{Cards: []int{}, Step: []int{0x38, 0x09, 0x2a, 0x3b, 0x1c}, CardNum: 12}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}}},
			turn: []int{}},
		{ai: &DoudizhuAI{MySeat: 0, Dizhu: 2, UsedCards: []int{0x19, 0x38, 0x37, 0x06, 0x15, 0x34, 0x33, 0x1c, 0x3b, 0x0a, 0x09, 0x08, 0x05, 0x28, 0x3a, 0x0b, 0x3c, 0x3d, 0x32, 0xf0, 0xf1, 0x16, 0x36, 0x02, 0x12, 0x07, 0x18, 0x29, 0x2a, 0x1b, 0x2c, 0x0d, 0x2e}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{0x03, 0x04, 0x23, 0x2d}, Step: []int{}, CardNum: 4}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 15}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 2}}},
			turn: []int{0x04}},
		{ai: &DoudizhuAI{MySeat: 0, Dizhu: 1, UsedCards: []int{0x05, 0x25, 0x35, 0x06, 0x26, 0x36, 0x03, 0x24, 0x0d, 0x1d, 0x3d, 0x2c, 0x08, 0x09, 0x0a, 0x2b, 0x0c, 0x2a, 0x0b, 0x3c, 0x2d, 0x0e, 0x07, 0x17, 0x27, 0x13, 0x38, 0x2e, 0x12, 0xf0, 0xf1, 0x23, 0x33, 0x18, 0x28, 0x1a, 0x3a, 0x34}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{0x04, 0x14, 0x1b, 0x22, 0x32, 0x3b, 0x3e}, Step: []int{}, CardNum: 7}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 1}, &DoudizhuUser{Cards: []int{}, Step: []int{0x34}, CardNum: 8}}},
			turn: []int{0x32},
		},
		// 小王没出
		{ai: &DoudizhuAI{MySeat: 2, Dizhu: 2, UsedCards: []int{0x03, 0x33, 0x14, 0x24, 0x05, 0x15, 0x0b, 0x3b, 0x1c, 0x2c, 0x0d, 0x3d, 0x12, 0x22, 0x32, 0x13, 0x35, 0xf1, 0x07, 0x38, 0x09, 0x3a, 0x1b, 0x0c, 0x1d, 0x2e}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 6}, &DoudizhuUser{Cards: []int{0x02, 0x06, 0x16, 0x26, 0x2d}, Step: []int{}, CardNum: 5}}}, turn: []int{0x06, 0x16, 0x26, 0x2d}},
		{ai: &DoudizhuAI{MySeat: 2, Dizhu: 2, UsedCards: []int{0x03, 0x33, 0x14, 0x24, 0x05, 0x15, 0x0b, 0x3b, 0x1c, 0x2c, 0x0d, 0x3d, 0x12, 0x22, 0x32, 0x13, 0x35}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}, &DoudizhuUser{Cards: []int{}, Step: []int{0x35}, CardNum: 6}, &DoudizhuUser{Cards: []int{0x02, 0x06, 0x07, 0x09, 0x0c, 0x16, 0x1b, 0x1d, 0x26, 0x2d, 0x2e, 0x38, 0x3a, 0xf1}, Step: []int{}, CardNum: 14}}}, turn: []int{0x2d}},
		// 5
		{ai: &DoudizhuAI{MySeat: 0, Dizhu: 1, UsedCards: []int{0x02, 0x22, 0x32, 0x05, 0x14, 0x25, 0x26, 0x17, 0x08, 0x38, 0x39, 0x2a, 0x2b, 0x3c, 0x19, 0x3a, 0x0b, 0x1c, 0x1d, 0x04, 0x36, 0x3b, 0x2c}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{0x06, 0x09, 0x23, 0x28, 0x2d, 0x34, 0x35, 0x37, 0x3d, 0x3e, 0xf1}, Step: []int{}, CardNum: 11}, &DoudizhuUser{Cards: []int{}, Step: []int{0x2c}, CardNum: 4}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 16}}}, turn: []int{0xf1}},
		{ai: &DoudizhuAI{MySeat: 1, Dizhu: 1, UsedCards: []int{}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}, &DoudizhuUser{Cards: []int{0x02, 0x04, 0x05, 0x08, 0x0b, 0x0e, 0x14, 0x17, 0x19, 0x1c, 0x1d, 0x1e, 0x22, 0x25, 0x26, 0x27, 0x2c, 0x32, 0x3a, 0xf0}, Step: []int{}, CardNum: 20}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}}}, turn: []int{0x25, 0x26, 0x17, 0x08, 0x19}},
		{ai: &DoudizhuAI{MySeat: 1, Dizhu: 1, UsedCards: []int{0x25, 0x26, 0x17, 0x08, 0x19}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}, &DoudizhuUser{Cards: []int{0x02, 0x04, 0x05, 0x0b, 0x0e, 0x14, 0x1c, 0x1d, 0x1e, 0x22, 0x27, 0x2c, 0x32, 0x3a, 0xf0}, Step: []int{}, CardNum: 20}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}}}, turn: []int{0x3a, 0x0b, 0x1c, 0x1d, 0x0e}},
		{ai: &DoudizhuAI{MySeat: 1, Dizhu: 1, UsedCards: []int{0x25, 0x26, 0x17, 0x08, 0x19, 0x3a, 0x0b, 0x1c, 0x1d, 0x0e}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}, &DoudizhuUser{Cards: []int{0x02, 0x04, 0x05, 0x14, 0x1e, 0x22, 0x27, 0x2c, 0x32, 0xf0}, Step: []int{}, CardNum: 20}, &DoudizhuUser{Cards: []int{}, Step: []int{}, CardNum: 17}}}, turn: []int{0x05}},
		{ai: &DoudizhuAI{MySeat: 0, Dizhu: 1, UsedCards: []int{0x1b, 0x2b, 0x3b, 0x0c, 0x1c, 0x3c, 0x03, 0x14, 0x36, 0x07, 0x08, 0x19, 0x1a, 0x28, 0x09, 0x0a, 0x0b, 0x2c, 0x23, 0x17, 0x12}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{0x02, 0x04, 0x22, 0x24, 0x25, 0x2d, 0x32, 0x37, 0x39, 0x3d, 0xf0}, Step: []int{}, CardNum: 11}, &DoudizhuUser{Cards: []int{}, Step: []int{0x17}, CardNum: 6}, &DoudizhuUser{Cards: []int{}, Step: []int{0x12}, CardNum: 16}}}, turn: []int{}},
		// 10
		{ai: &DoudizhuAI{MySeat: 1, Dizhu: 1, UsedCards: []int{0x04, 0x14, 0x34, 0x15, 0x25, 0x35, 0x23, 0x06, 0x07, 0x17, 0x27, 0x37, 0x33, 0x2a, 0x1b, 0x3c, 0x1e, 0x22, 0x24, 0x2b, 0x1d, 0x12, 0xf0, 0x26, 0x0d, 0x02, 0x0c, 0x1c, 0x2c, 0x05, 0x0e, 0x2e, 0x3e, 0x39, 0x1a, 0x0b, 0x2d, 0x32, 0x03, 0x13, 0x0a, 0x3a}, Users: []*DoudizhuUser{&DoudizhuUser{Cards: []int{}, Step: []int{0x0a, 0x3a}, CardNum: 3}, &DoudizhuUser{Cards: []int{0x08, 0x09, 0x18, 0x19, 0x28, 0x38}, Step: []int{}, CardNum: 6}, &DoudizhuUser{Cards: []int{}, Step: []int{0x03, 0x13}, CardNum: 3}}}, turn: []int{0x08, 0x18, 0x28, 0x38}},
	}
